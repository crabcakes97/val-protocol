; flow candidate 0x000000004805a2b4-0x000000004805a302
; score: 2
...
>> 0x000000004805a2c4: add      r0, pc
   ...
   0x000000004805a2da: bl       #0x48059fb4  ; call 0x0000000048059fb4
   ...
   0x000000004805a2ec: bl       #0x4806ff38  ; call 0x000000004806ff38
   0x000000004805a2ee: cdp2     p8, #2, c6, c4, c0, #1
   0x000000004805a2f0: ldr      r0, [r4]
   0x000000004805a2f2: pop      {r3, r4, r5, pc}

loc_000000004805a2f4:
   0x000000004805a2f4: ldr      r1, [pc, #0x1c]
   0x000000004805a2f6: movs     r0, #1
; XREF string 0x00000000480e2294: 'barcode' -> 'No barcode setting, use default width 3\n'
>> 0x000000004805a2f8: add      r1, pc
   0x000000004805a2fa: bl       #0x4806ff38  ; call 0x000000004806ff38
   0x000000004805a2fc: cdp2     p0, #1, c2, c13, c3, #0
   0x000000004805a2fe: movs     r0, #3
   0x000000004805a300: str      r0, [r4]
   0x000000004805a302: pop      {r3, r4, r5, pc}
