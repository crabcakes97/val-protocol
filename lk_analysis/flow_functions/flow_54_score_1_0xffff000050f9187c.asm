; flow candidate 0xffff000050f9187c-0xffff000050f91908
; score: 1
; matched targets: imei
; calls: 0xffff000050f9b7e8
...
>> 0xffff000050f918dc: add      x0, x0, #0x68
   0xffff000050f918e0: bl       #0xffff000050f9b7e8  ; call 0xffff000050f9b7e8
