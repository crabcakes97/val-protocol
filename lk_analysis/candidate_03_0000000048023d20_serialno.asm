; candidate function around xref 0x0000000048023d2a to 'serialno'
; estimated range 0x0000000048023d20-0x0000000048023d94
...
>> 0x0000000048023d2a: add      r7, pc
   ...
   0x0000000048023d2e: bl       #0x480382ec
   ...
   0x0000000048023d6e: bl       #0x4801edd0
   ...
   0x0000000048023d84: bl       #0x480380fc
