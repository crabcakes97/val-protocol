; candidate function around xref 0x0000000048082efc to 'This command requires you to first unlock the bootloader'
; estimated range 0x0000000048082e88-0x0000000048082f0e
