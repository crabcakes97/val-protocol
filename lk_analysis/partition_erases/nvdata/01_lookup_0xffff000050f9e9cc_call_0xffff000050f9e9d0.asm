...
; xref: 0xffff000050f9e9cc off=0x9e9cc HxD=0009E9CC
; xref instruction: add x0, x0, #0xdd6
; xref via: adrp/add x0
; call site: 0xffff000050f9e9d0 off=0x9e9d0 HxD=0009E9D0
; call target: 0xffff000050f25598 off=0x25598 HxD=00025598
; result check: 0xffff000050f9e9d4 off=0x9e9d4 HxD=0009E9D4
...
>> 0xffff000050f9e9cc: add      x0, x0, #0xdd6 ; XREF
>> 0xffff000050f9e9d0: bl       #0xffff000050f25598 ; CALL
>> 0xffff000050f9e9d4: cmn      w0, #1 ; CHECK
