...
; xref: 0xffff000050f9ebb4 off=0x9ebb4 HxD=0009EBB4
; xref instruction: add x0, x0, #0xdd6
; xref via: adrp/add x0
; call site: 0xffff000050f9ebb8 off=0x9ebb8 HxD=0009EBB8
; call target: 0xffff000050f25598 off=0x25598 HxD=00025598
; result check: 0xffff000050f9ebbc off=0x9ebbc HxD=0009EBBC
...
>> 0xffff000050f9ebb4: add      x0, x0, #0xdd6 ; XREF
>> 0xffff000050f9ebb8: bl       #0xffff000050f25598 ; CALL
>> 0xffff000050f9ebbc: cmn      w0, #1 ; CHECK
