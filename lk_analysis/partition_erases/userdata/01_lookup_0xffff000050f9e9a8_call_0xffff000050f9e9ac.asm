...
; xref: 0xffff000050f9e9a8 off=0x9e9a8 HxD=0009E9A8
; xref instruction: add x0, x0, #0x574
; xref via: adrp/add x0
; call site: 0xffff000050f9e9ac off=0x9e9ac HxD=0009E9AC
; call target: 0xffff000050f25598 off=0x25598 HxD=00025598
; result check: 0xffff000050f9e9b0 off=0x9e9b0 HxD=0009E9B0
...
>> 0xffff000050f9e9a8: add      x0, x0, #0x574 ; XREF
>> 0xffff000050f9e9ac: bl       #0xffff000050f25598 ; CALL
>> 0xffff000050f9e9b0: cmn      w0, #1 ; CHECK
