...
; xref: 0xffff000050f9eba4 off=0x9eba4 HxD=0009EBA4
; xref instruction: add x0, x0, #0x574
; xref via: adrp/add x0
; call site: 0xffff000050f9eba8 off=0x9eba8 HxD=0009EBA8
; call target: 0xffff000050faf874 off=0xaf874 HxD=000AF874
; result check: 0xffff000050f9ebac off=0x9ebac HxD=0009EBAC
; failure target: 0xffff000050f9ec74 off=0x9ec74 HxD=0009EC74
...
>> 0xffff000050f9eba4: add      x0, x0, #0x574 ; XREF
>> 0xffff000050f9eba8: bl       #0xffff000050faf874 ; CALL
>> 0xffff000050f9ebac: tbnz     x0, #0x3f, #0xffff000050f9ec74 ; CHECK
