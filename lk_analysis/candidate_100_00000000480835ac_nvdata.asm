; candidate function around xref 0x00000000480835d2 to 'nvdata'
; estimated range 0x00000000480835ac-0x00000000480835e4
...
>> 0x00000000480835d2: add      r1, pc
   0x00000000480835d4: bl       #0x4806ff38
   ...
   0x00000000480835de: bl       #0x48038150
