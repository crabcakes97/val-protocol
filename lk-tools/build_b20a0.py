...
def build_handler(usage_va, tbl_va, deny_va, data_va, empty_va, lenhex_va):
    ...
    a.label("bulk_go")
    # LADDER rung A0: dispatch lands here, IMMEDIATE OKAY. Skips snapshot,
    # header-build, all stubs. Isolates parse/end-select/dispatch (+ path).
    # Expect: OKAY + alive. Crash => fault in +-parse or bulk end-select.
    a.b("bulk_ok")
