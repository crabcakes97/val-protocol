#!/usr/bin/env python3
"""readdump LADDER rung B: b19 + only 7E34 flush executes.
...
def build_handler(usage_va, tbl_va, deny_va, data_va, empty_va, lenhex_va):
    ...
    # LADDER rung B: header built, ONLY 7E34 flush executes.
    # Expect: OKAY + alive (flush safe alone) or crash (flush needs state).
    a.b("bulk_flush")
    ...
    # LADDER rung B lands here from below (bulk_flush), skipping sends.
    a.label("bulk_flush")
