#!/usr/bin/env python3
"""readdump bulk-18: b17 + bulk-flag fix (flag lives in x16; the table
loop's `ldp x13,x14` ate the old w13 flag so dispatch ALWAYS fell into
bulk_go and the INFO path was dead code -- that's why nothing happened).
