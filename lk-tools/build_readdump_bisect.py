...
def build_handler(usage_va, tbl_va, deny_va):
    ...
    e(movz(22, 1, 0))  # BISECT mov w22,#1 (expect exactly 1 line)
    a.label("line")
...
EXPECTED_MNEMONICS = (
    ...
    "mov mov sub mov ldrb lsr and cmp b.ls add add strb and cmp b.ls add add strb "
    "add cmp b.ne strb sub adrp add bl add sub cmp b.ne mov b "
