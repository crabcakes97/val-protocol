...
def build_handler(usage_va, tbl_va, deny_va, data_va, empty_va, lenhex_va,
    ...
    # convention-A try: F29978(w0=ch, x1=fmt, x2+=varargs) printf-style.
    # (b23 convention-B with empty tag framed nothing: EOVERFLOW, alive.)
    e(W(0x12800000))  # mov w0,#-1 (stock word, cf A804/A97C)
    a.adrp_add(1, BASE + 0xDDD40)  # x1 = "DATA%08x" (in-file fmt)
    e(W(0x52880002))  # mov w2,#0x4000 (len vararg; render-verified)
    e(W(0xD2800003))  # mov x3,#0 (spare vararg slot cleared)
...
NEED_OPS = {
    ...
    "mov w2,#0x4000": "fmt len vararg",
    "mov x3,#0": "spare vararg cleared",
    "mov x0,x19": "bulk buf",
