#!/usr/bin/env python3
"""readdump LADDER rung C: b19 + only 12B header via 7E24 executes.
...
def build_handler(usage_va, tbl_va, deny_va, data_va, empty_va, lenhex_va):
    ...
    # LADDER rung C: 12B header sent via 7E24, skip data+flush.
    # Expect: OKAY + alive (7E24 cold-call safe) or crash (needs preamble).
    a.b("bulk_ok")
    ...
    # LADDER rung C skips data+flush (bulk_ok) -- only the 12B header
    # send above executes.
    a.label("bulk_flush")
