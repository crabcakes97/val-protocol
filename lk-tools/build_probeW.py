...
WINDOWS = (
    ...
    # LINEAR-e00 extent test: registry e00 = phys [0x50F00000,+288MB] as
    # Normal. If descriptors cover it all, phys 0x52000000 reads HERE
    # (no remap needed for low DRAM!). ONE probe; fault = image-only.
    (0xFFFF000052000000, 0xFFFF000052100000),
)
